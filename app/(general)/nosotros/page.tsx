      ...
      <div className="mx-auto max-w-screen-xl px-4 lg:px-0">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="md:col-span-2 order-2 md:order-1">
             <div className="w-full h-auto min-h-80 md:min-h-0 md:h-72 bg-[#FF5E14] text-white rounded-md flex flex-col items-start justify-start text-left p-6">
                 ...
                 <div className="space-y-2 text-white/90 text-base md:text-sm lg:text-base leading-relaxed overflow-y-auto pr-2">
                     <p>
          ...
          <div className="relative w-full bg-white rounded-md overflow-hidden h-80 md:h-72 order-1 md:order-2">
                <img 
          ...
          <div className="order-3 md:order-3">
             <div className="w-full h-auto min-h-80 md:min-h-0 md:h-72 bg-[#FF5E14] text-white rounded-md flex flex-col p-6 overflow-hidden">
                <div className="flex items-center gap-4 mb-2 flex-shrink-0">
                     <div className="w-14 h-14 relative">
                          <img 
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-4 gap-6">
             ...
             {/* Nueva Sección: Texto Transformando (1 Col) */}
            <div className="w-full h-auto min-h-80 md:min-h-0 md:h-72 flex flex-col justify-center p-5 md:p-5">
            ...
            {/* Nueva Sección: Imagen Central (2 Cols) */}
            <div className="md:col-span-2 relative w-full h-80 md:h-72 rounded-md overflow-hidden">
                <img 
            ...
            {/* Nueva Sección: Cotización (1 Col) */}
             <a 
                href="https://wa.me/522218382382" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-full h-auto min-h-80 md:min-h-0 md:h-72 bg-[#FF5E14] text-white rounded-md flex flex-col items-center justify-center text-center p-6 transition-transform hover:scale-[1.02] cursor-pointer"
             >
